...
func TestMetadataMethods(t *testing.T) {
	...
	var tokenMethods = []string{"addDocs", "allowedBalanceOf", "lockedAllowedBalanceOf",
		...
		"channelTransferByAdmin", "channelMultiTransferByAdmin",
		"channelTransferByCustomer", "channelMultiTransferByCustomer",
		"channelTransferFrom", "channelTransferTo", "channelTransfersFrom", "commitCCTransferFrom", "coreChaincodeIDName",
