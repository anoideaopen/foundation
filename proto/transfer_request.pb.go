...
const (
	...
	BalanceType_BALANCE_TYPE_TOKEN_LOCKED            BalanceType = 46 // 0x2e
	BalanceType_BALANCE_TYPE_TOKEN_EXTERNAL_LOCKED   BalanceType = 50 // 0x32
	BalanceType_BALANCE_TYPE_ALLOWED                 BalanceType = 44 // 0x2c
	BalanceType_BALANCE_TYPE_ALLOWED_LOCKED          BalanceType = 47 // 0x2f
	BalanceType_BALANCE_TYPE_ALLOWED_EXTERNAL_LOCKED BalanceType = 49 // 0x31
	BalanceType_BALANCE_TYPE_GIVEN                   BalanceType = 45 // 0x2d
)
...
var (
	BalanceType_name = map[int32]string{
		...
		46: "BALANCE_TYPE_TOKEN_LOCKED",
		50: "BALANCE_TYPE_TOKEN_EXTERNAL_LOCKED",
		44: "BALANCE_TYPE_ALLOWED",
		47: "BALANCE_TYPE_ALLOWED_LOCKED",
		49: "BALANCE_TYPE_ALLOWED_EXTERNAL_LOCKED",
		45: "BALANCE_TYPE_GIVEN",
	}
	BalanceType_value = map[string]int32{
		"BALANCE_TYPE_UNSPECIFIED":             0,
		"BALANCE_TYPE_TOKEN":                   43,
		"BALANCE_TYPE_TOKEN_LOCKED":            46,
		"BALANCE_TYPE_TOKEN_EXTERNAL_LOCKED":   50,
		"BALANCE_TYPE_ALLOWED":                 44,
		"BALANCE_TYPE_ALLOWED_LOCKED":          47,
		"BALANCE_TYPE_ALLOWED_EXTERNAL_LOCKED": 49,
		"BALANCE_TYPE_GIVEN":                   45,
	}
)
...
type TransferRequest struct {
	...
	FromBalanceType BalanceType `protobuf:"varint,13,opt,name=from_balance_type,json=fromBalanceType,proto3,enum=proto.BalanceType" json:"from_balance_type,omitempty"`
	// Balance type to which the transfer is made
	ToBalanceType BalanceType `protobuf:"varint,14,opt,name=to_balance_type,json=toBalanceType,proto3,enum=proto.BalanceType" json:"to_balance_type,omitempty"`
...
func (x *TransferRequest) GetFromBalanceType() BalanceType {
	if x != nil {
		return x.FromBalanceType
	}
	return BalanceType_BALANCE_TYPE_UNSPECIFIED
}

func (x *TransferRequest) GetToBalanceType() BalanceType {
	if x != nil {
		return x.ToBalanceType
	}
	return BalanceType_BALANCE_TYPE_UNSPECIFIED
}
...
var file_transfer_request_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc9, 0x06, 0x0a, 0x0f, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65,
	0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x26, 0x0a, 0x0a, 0x72, 0x65, 0x71, 0x75,
	...
	,
	...
	,
	...
	,
...
var file_transfer_request_proto_depIdxs = []int32{
	...
	2, // 3: proto.TransferRequest.from_balance_type:type_name -> proto.BalanceType
	2, // 4: proto.TransferRequest.to_balance_type:type_name -> proto.BalanceType
	5, // 5: proto.TransferRequest.additional_info:type_name -> google.protobuf.Any
