...
func swapAnswer(stub *cache_stub.BatchCacheStub, swap *proto.Swap) (r *proto.SwapResponse) {
...
func swapRobotDone(stub *cache_stub.BatchCacheStub, swapID []byte, key string) (r *proto.SwapResponse) {
